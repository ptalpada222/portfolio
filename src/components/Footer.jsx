...
const Footer = () => {
  ...
  return (
    <footer className="py-10 bg-gradient-to-t from-gray-100/50 to-gray-100 dark:from-gray-900/50 dark:to-gray-900 border-t border-gray-200/50 dark:border-gray-700/50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Prakash Talpada. All rights reserved.
          </motion.p>
